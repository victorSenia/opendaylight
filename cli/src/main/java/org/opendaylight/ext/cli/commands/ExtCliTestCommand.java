 ...
 */
package org.opendaylight.ext.cli.commands;
...
public class ExtCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ExtCliTestCommand.class);
    protected final ExtCliCommands service;

    public ExtCliTestCommand(final ExtCliCommands service) {
